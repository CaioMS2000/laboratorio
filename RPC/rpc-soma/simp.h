...
#define DIVI 3
extern  double * divi_1(operands *, CLIENT *);
extern  double * divi_1_svc(operands *, struct svc_req *);
#define MULT 4
extern  double * mult_1(operands *, CLIENT *);
extern  double * mult_1_svc(operands *, struct svc_req *);
